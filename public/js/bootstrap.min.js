        ...
        this._queueCallback(
          () => {
            this._isWithActiveTrigger() ||
              (this._isHovered || t.remove(), this._element.removeAttribute('aria-describedby'), $.trigger(this._element, this.constructor.eventName('hidden')), this._disposePopper())
          },
          this.tip,
          this._isAnimated()
        )
  ...
  class Be extends V {
    ...
    _process(t) {
      this._activeTarget !== t &&
        (this._clearActiveClass(this._config.target), (this._activeTarget = t), t.classList.add(Fe), this._activateParents(t), $.trigger(this._element, 'activate.bs.scrollspy', { relatedTarget: t }))
    }
    _activateParents(t) {
    ...
    _deactivate(t, e) {
      t &&
        ...
        this._queueCallback(
          () => {
            'tab' === t.getAttribute('role')
              ? (t.setAttribute('aria-selected', !1), t.setAttribute('tabindex', '-1'), this._toggleDropDown(t, !1), $.trigger(t, 'hidden.bs.tab', { relatedTarget: e }))
